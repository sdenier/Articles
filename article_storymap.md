...
PAS DE RAPPEL SUR LE PRINCIPE D'UNE STORY MAP? (uniformiser le vocabulaire)
...
La granularité des activités et cas d'utilisation étaient très variables au sein d'une story map. Suivant une certaine loi de futilité, certains aspects "simples" se retrouvaient au même niveau dans la story map que des aspects complexes (similaire à http://fr.wikipedia.org/wiki/Loi_de_futilité_de_Parkinson). En essayant de balayer toutes les activités du projet, nous ne pouvions pas passer autant de temps que nécessaire sur les aspects les plus complexes.
...
(2) Sur le sujet délicat des estimations, comment les faire, les exploiter intelligemment et les éviter quand ce n'est pas utile, je recommande Dan North et aussi tout ce qui touche au mouvement NoEstimates. Mais c'est l'objet d'un autre débat.
