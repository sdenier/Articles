...
La vision du projet est bien sûr un différenciateur. Si cela ne semble pas assez différenciant, creusez encore : la différence n'est pas nécessairement exprimée par une nouvelle fonctionnalité, mais par une nouvelle approche des activités, par un modèle de business alternatif…
